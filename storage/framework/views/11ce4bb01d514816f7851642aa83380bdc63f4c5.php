<div class="featured-listing container-fluid">
    <div class="container">
        <div class="section-title mb-3 row">
            ...
            <p>Take a look at the Featured Listings.  Don’t  find What you looking for ? <a class="text-primary" href="<?php echo e(route('all-listings')); ?>">View All Listings</a>
        </div>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Card\GridCard::class, ['list' => $list,'footTyp' => 'review'] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/php-scripts/smart-directory/resources/views/components/home/featured-listings.blade.php ENDPATH**/ ?>