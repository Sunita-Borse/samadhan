...
<?php $component = $__env->getContainer()->make(App\View\Components\Card\Category::class, ['category' => $fc] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('card.category'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(App\View\Components\Card\Category::class))->getConstructor()): ?>
...
</section><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/php-scripts/smart-directory/resources/views/components/home/featured-category.blade.php ENDPATH**/ ?>