<section x-data="review">
    <div  id="revbox" class="review-box overview shadow-sm ">
        ...
        <div x-show="reviews.lengt < 1">
            <?php if(!empty($review)): ?> <?php $__currentLoopData = $review; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="row reviewrow">
                <div class="col-md-2 col-3 ">
                    <img class="rounded-circle border border-1 p-2" src="<?php echo e($rev->user->resize); ?>" alt="">
                </div>
                <div class="col-md-10 align-items-center col-9 rcolm"> 
                    <div class="review">
                        <i class="bi <?php if($rev->rating >= 1): ?> act <?php endif; ?> act bi-star-fill"></i>
                        <i class="bi <?php if($rev->rating >= 2): ?> act <?php endif; ?> bi-star-fill"></i>
                        <i class="bi <?php if($rev->rating >= 3): ?> act <?php endif; ?> bi-star-fill"></i>
                        <i class="bi <?php if($rev->rating >= 4): ?> act <?php endif; ?> bi-star-fill"></i>
                        <i class="bi <?php if($rev->rating >= 5): ?> act <?php endif; ?>  bi-star-fill"></i>
                    </div>
                    <h3><?php echo e($rev->user->name); ?></h3>
                    <small> <?php echo e(\Carbon\Carbon::parse($rev->created_at)->format('d M Y')); ?> </small>
                    <div class="review-text">
                        <?php echo e($rev->message); ?> 
                    </div>
                </div>
            </div>
            ...
            <div class="row reviewrow">
                ...
                <div class="col-md-10 col-9 align-content-center rcolm"> 
                    ...
                    <div  class="review-text">
                        ...
                        <ul x-show="r.user.id == <?php echo e($uid); ?>" class="actionreview">
...
<?php if (! $__env->hasRenderedOnce('3f385a91-e311-4509-9bdd-752d4ef6f68a')): $__env->markAsRenderedOnce('3f385a91-e311-4509-9bdd-752d4ef6f68a');
...
<?php $__env->stopPush(); endif; ?><?php /**PATH /home/customer/www/abhijeetm14.sg-host.com/public_html/resources/views/components/business/review.blade.php ENDPATH**/ ?>